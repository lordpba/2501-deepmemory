...
- **Multi-Provider LLM** — Use local **Ollama** (suggested, very good even with 4b or 9b models :) ), **OpenAI**, **Google Gemini**, **Anthropic Claude**, and also **ReiLab API** ! ([reilabs.org](https://reilabs.org/)).
...
### Setting up Ollama
For local LLM support, download and install Ollama from [ollama.com](https://ollama.com). 
2501 includes **automatic Ollama detection and service startup** on most systems. You can also specify remote LAN endpoints (e.g., a DGX server) in the settings.
